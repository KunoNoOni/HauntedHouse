package
{
	...
	public class Bat extends FlxSprite
	{
		...
		public function Bat(X:Number, Y:Number)
		{
			super(X*16,Y*16);
			loadGraphic(Registry.Bat,true,false,16,16);
			addAnimation("flap",[0,1],5,true);
			
			rnd = Math.floor(Math.random()*4)+1;
			floor = rnd;
			//trace("Bat is starting on floor "+this.floor);
		}
		...
		public function setPath():void
		{
			...
			//trace("The Bat is at "+Math.floor(this.x)/16+","+Math.floor(this.y)/16);
